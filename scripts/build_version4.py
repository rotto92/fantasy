...
def main() -> None:
    ...
    guide_rows = [
        ...
        ["Five shipped views", "Constellations maps normalized concepts; Catalogue lists them by family; Compose combines one being concept and one role concept as a user-created character; Relations shows one selected concept's bounded neighborhood; Research reports source-pass and review status.", "Keeps every documented control aligned with the public D3 application while preserving one evidence model across views."],
